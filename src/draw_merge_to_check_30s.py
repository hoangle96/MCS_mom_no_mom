                    ...
                    for subj in subj_list:
                        for task in tasks:
                            ...
                            if len(time_list) != len(prob_list):
                                print(subj, task, shift_time)
                            fig_name = './figures/hmm/state_distribution_20210815_30s/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states/all_sequences/'+task+'/'+str(subj)+".png"
