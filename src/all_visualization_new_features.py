...
from visualization import draw_toy_state, draw_distribution, draw_timeline_with_merged_states, draw_state_distribution, draw_infant_each_min_matplotlib, draw_mean_state_locotion_across_conditions, draw_timeline_with_prob_to_check
        ...
        for no_ops_time in [10, 7]:
            ...
            for interval_length in [1.5, 2, 1]:
                ...
                for n_states in [4]:#range(4, 7):
                    ...
                    with open('./data/interim/20210815_'+feature_set+'_'+str(no_ops_time)+'_no_ops_theshold_'+str(n_states)+'_states_toy_pred_dict_'+str(interval_length)+'_min.pickle', 'rb') as f:
                ...
                ### state pred figures
                    ...
                    for task in tasks:
                        ...
                        fig_path = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+"_states/distribution_time_in_state_"+task+".png"
                    ...
                    fig_path = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+"_states/state_distribution.png"  
                    ...
                    # fig_path = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+"_states/emission_distribution.png"
                    ...
                    #     for task in tasks:
                    #         path = Path('./figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states/merged/'+task+'/')
                    ...
                    #                                         state_name = state_name_dict, fig_name= fig_name, gap_size = shift,\
                    ...
                    #             path = Path('./figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states/shift_'+str(shift_time)+'/'+task+'/')
                    #             path.mkdir(parents=True, exist_ok=True)
                    ...
                    #                 print(subj, task, shift_time)
                    #             else:
                    #                 fig_name = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states/shift_'+str(shift_time)+'/'+task+'/'+str(subj)+".png"
                ...
                # toy state figures 
                    ...
                    # fig_path = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states'+'/toy_state_stationary.png'
                    ...
                    # fig_path = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states'+'/toy_state_mobile.png'
                    ...
                    #     fig_path = './figures/hmm/state_distribution_20210815/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states'+'/'+task+'.png'
