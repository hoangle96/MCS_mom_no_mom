...
for state in range(n_states):
    ...
    print(
        ztest(
            steps_by_each_task["NMM"][state] + steps_by_each_task["MPM"][state],
            steps_by_each_task["NMS"][state] + steps_by_each_task["MPS"][state],
            alternative="larger",
        )
    )
    ...
    print(
        ztest(
            movement_time_by_each_task["NMM"][state]
            + movement_time_by_each_task["MPM"][state],
            movement_time_by_each_task["NMS"][state]
            + movement_time_by_each_task["MPS"][state],
        )
    )
...
for state in range(n_states):
    ...
    print(
        ztest(
            steps_by_each_task["NMM"][state],
            steps_by_each_task["MPM"][state],
            alternative="larger",
        )
    )
    ...
    print(
        ztest(
            steps_by_each_task["NMS"][state],
            steps_by_each_task["MPS"][state],
            alternative="larger",
        )
    )
# %%
...
print(
    "Fine motor toy, no caregiver, state 3 > 2",
    ztest(
        movement_time_by_each_task["NMS"][3],
        movement_time_by_each_task["NMS"][2],
        alternative="larger",
    ),
)
print(
    "Fine motor toy, no caregiver, state 3 > 4",
    ztest(
        movement_time_by_each_task["NMS"][3],
        movement_time_by_each_task["NMS"][4],
        alternative="larger",
    ),
)
print(
    "Fine motor toy, no caregiver, state 2 > 1",
    ztest(
        movement_time_by_each_task["NMS"][2],
        movement_time_by_each_task["NMS"][1],
        alternative="larger",
    ),
)

print(
    "Fine motor toy, with caregiver, state 3 > 2",
    ztest(
        movement_time_by_each_task["MPS"][3],
        movement_time_by_each_task["MPS"][2],
        alternative="larger",
    ),
)
print(
    "Fine motor toy, with caregiver, state 3 > 1",
    ztest(
        movement_time_by_each_task["MPS"][3],
        movement_time_by_each_task["MPS"][1],
        alternative="larger",
    ),
)
print(
    "Fine motor toy, with caregiver, state 3 > 4",
    ztest(
        movement_time_by_each_task["MPS"][3],
        movement_time_by_each_task["MPS"][4],
        alternative="larger",
    ),
)
print(
    "Fine motor toy, with caregiver, state 2 > 1",
    ztest(
        movement_time_by_each_task["MPS"][2],
        movement_time_by_each_task["MPS"][1],
        alternative="larger",
...
print("\n")
print(
    "Gross motor toy, no caregiver, state 3 > 4",
    ztest(
        movement_time_by_each_task["NMM"][3],
        movement_time_by_each_task["NMM"][4],
        alternative="larger",
    ),
)
print(
    "Gross motor toy, no caregiver, state 3 > 2",
    ztest(
        movement_time_by_each_task["NMM"][3],
        movement_time_by_each_task["NMM"][2],
        alternative="larger",
    ),
)
print(
    "Gross motor toy, no caregiver, state 3 > 1",
    ztest(
        movement_time_by_each_task["NMM"][3],
        movement_time_by_each_task["NMM"][1],
        alternative="larger",
    ),
)
print(
    "Gross motor toy, with caregiver, state 3 > 4",
    ztest(
        movement_time_by_each_task["NMM"][3],
        movement_time_by_each_task["NMM"][4],
        alternative="larger",
...
print(
    "Gross motor toy, with caregiver, state 3 > 2",
    ztest(
        movement_time_by_each_task["NMM"][3],
        movement_time_by_each_task["NMM"][2],
        alternative="larger",
...
print(
    "Gross motor toy, with caregiver, state 3 > 1",
    ztest(
        movement_time_by_each_task["NMM"][3],
        movement_time_by_each_task["NMM"][1],
        alternative="larger",
...
# %%
print(
    "Gross motor toy, E states > F states",
    ztest(
        movement_time_by_each_task["NMM"][3]
        + movement_time_by_each_task["NMM"][4]
        + movement_time_by_each_task["MPM"][3]
        + movement_time_by_each_task["MPM"][4],
        movement_time_by_each_task["NMM"][1]
        + movement_time_by_each_task["NMM"][2]
        + movement_time_by_each_task["MPM"][1]
        + movement_time_by_each_task["MPM"][2],
        alternative="larger",
    ),
)
print(
    "Gross motor toy, with caregiver, E states > F states",
    ztest(
        movement_time_by_each_task["MPM"][3] + movement_time_by_each_task["MPM"][4],
        movement_time_by_each_task["MPM"][1] + movement_time_by_each_task["MPM"][2],
        alternative="larger",
    ),
)
print(
    "Gross motor toy, without caregiver, E states > F states",
    ztest(
        movement_time_by_each_task["NMM"][3] + movement_time_by_each_task["NMM"][4],
        movement_time_by_each_task["NMM"][1] + movement_time_by_each_task["NMM"][2],
        alternative="larger",
    ),
)

print(
    "Fine motor toy, E states > F states",
    ztest(
        movement_time_by_each_task["NMS"][3]
        + movement_time_by_each_task["NMS"][4]
        + movement_time_by_each_task["MPS"][3]
...
print(
    "Fine motor toy, with caregiver, E states > F states",
    ztest(
        movement_time_by_each_task["MPS"][3] + movement_time_by_each_task["MPS"][4],
        movement_time_by_each_task["MPS"][1] + movement_time_by_each_task["MPS"][2],
        alternative="larger",
    ),
)

print(
    "Fine motor toy, without caregiver, E states > F states",
    ztest(
        movement_time_by_each_task["NMS"][3] + movement_time_by_each_task["NMS"][4],
        movement_time_by_each_task["NMS"][1] + movement_time_by_each_task["NMS"][2],
        alternative="larger",
    ),
)
...
print(
    "Fine motor toy, state 3 > 2",
    ztest(
        steps_by_each_task["NMS"][3]
        + steps_by_each_task["MPS"][3]
        + steps_by_each_task["NMS"][3]
        + steps_by_each_task["MPS"][3],
...
print(
    "Gross motor toy, state 3 > 0",
    ztest(
        steps_by_each_task["NMM"][3]
        + steps_by_each_task["MPM"][3]
        + steps_by_each_task["NMM"][3]
        + steps_by_each_task["MPM"][3],
...
print(
    ztest(
        ...
        + movement_time_by_each_task["MPM"][1]
        + movement_time_by_each_task["MPS"][1],
        movement_time_by_each_task["NMM"][0]
        + movement_time_by_each_task["NMS"][0]
        + movement_time_by_each_task["MPM"][0]
        + movement_time_by_each_task["MPS"][0],
        alternative="larger",
    )
)
