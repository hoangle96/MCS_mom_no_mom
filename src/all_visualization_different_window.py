        ...
        for no_ops_time in [10,7, 5]:
            ...
            for interval_length in [1.5, 2, 1]:
                ...
                for n_states in range(4, 7):
                    ...
                    with open('./data/interim/20210815_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold'+str(n_states)+'_states_merged_prediction_'+str(interval_length)+'_min.pickle', 'rb') as f:
                        merged_pred_dict_all = pickle.load(f)

                    with open('./data/interim/20210815_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold'+str(n_states)+'_states_merged_prediction_prob_'+str(interval_length)+'_min.pickle', 'rb') as f:
                    ...
                    with open('./data/interim/20210815_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_theshold_'+str(n_states)+'_states_toy_pred_dict_'+str(interval_length)+'_min.pickle', 'rb') as f:
                ...
                ### state pred figures
                    ...
                    for task in tasks:
                        ...
                        fig_path = './figures/hmm/state_distribution_20210815_30s/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+"_states/distribution_time_in_state_"+task+".png"
                        draw_state_distribution(flatten_pred_dict[task], n_states, state_name_dict, condition_name[task], state_color_dict, fig_path)
                    fig_path = './figures/hmm/state_distribution_20210815_30s/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+"_states/state_distribution.png"  
                    ...
                    fig_path = './figures/hmm/state_distribution_20210815_30s/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+"_states/emission_distribution.png"
                ...
                #     # n_infants state per min 
                    if n_states == 5:
                        ...
                        for task in tasks:
                            ...
                            file_name = './figures/hmm/state_distribution_20210815_30s/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/'+str(n_states)+'_states'+'/'+"n_infants_each_state_per_min_"+task+'.png'
