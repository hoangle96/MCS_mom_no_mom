...
# for feature_set in ['new_toy_play_time_ratio']:
    ...
    for no_ops_time in [10, 5, 7]:
        ...
        for interval_length in [1.5, 2, 1]:
            ...
            with open("./data/interim/20210816_30s_offset_"+feature_set+'_'+str(no_ops_time)+"_no_ops_threshold_discretized_input_list_"+str(interval_length)+"_min.pickle", 'wb+') as f:
            ...
            for n_states in range(4, 7):
                ...
                features_obs_dict = {0: len(toy_switch_bins) , 1: 5, 2: 4, 3: 5}
                ...
                file_path = Path('/scratch/mom_no_mom/reports/20210816_30s_offset/'+feature_set+'/no_ops_threshold_'+str(no_ops_time)+'/window_size_'+str(interval_length)+'/state_'+str(n_states))
                file_name = 'mean_'+str(n_states)+"_states_seed_"+str(seed)+".csv"
                ...
                file_name = 'trans_matrix_'+str(n_states)+"_states_seed_"+str(seed)+'_'+str(interval_length)+'_min.csv'
                ...
                with open('./data/interim/20210816_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold_'+str(n_states)+'_states_prediction_all_prob_'+str(interval_length)+'_min.pickle', 'wb+') as f:
                    pickle.dump(all_proba_dict, f)

                with open('./data/interim/20210816_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold_'+str(n_states)+'_states_prediction_'+str(interval_length)+'_min.pickle', 'wb+') as f:
                ...
                for task in tasks:
                    ...
                    merged_pred_dict_all_task_specific, merged_proba_dict_all_task_specific, time_subj_dict_all_task_specific, _ = merge_segment_with_state_calculation_all(subj_list, shift_time_list, merged_df_dict, time_arr_shift_dict, pred_subj_dict, prob_subj_dict, window_size = interval_length, n_states = n_states, shift_interval = 60000*shift)
                ...
                with open('./data/interim/20210816_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold'+str(n_states)+'_states_merged_prediction_'+str(interval_length)+'_min.pickle', 'wb+') as f:
                    pickle.dump(merged_pred_dict_all, f)

                with open('./data/interim/20210816_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold'+str(n_states)+'_states_merged_prediction_prob_'+str(interval_length)+'_min.pickle', 'wb+') as f:
                    pickle.dump(merged_proba_dict_all, f)

                with open('./data/interim/20210816_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_threshold'+str(n_states)+'_states_time_arr_dict_'+str(interval_length)+'_min.pickle', 'wb+') as f:
                    pickle.dump(time_subj_dict_all, f)
                
                with open('./data/interim/20210816_30s_offset'+feature_set+'_'+str(no_ops_time)+'_no_ops_theshold_'+str(n_states)+'_states_toy_pred_dict_'+str(interval_length)+'_min.pickle', 'wb+') as f:
